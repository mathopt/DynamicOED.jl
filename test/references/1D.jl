...
@testset "Relaxed" begin 
    ...
    for (i,crit) in enumerate(TEST_CRITERIA)
        ...
        @test isapprox(res.u, [0., 0., 0., 1.0, 1.0, 1.0, 1.0, 0., 0., 0.], atol = 1e-5, rtol = 1e-1)
        @test isapprox(res.objective, i <= 3 ? -1.2823515846720533e-02 : 77.98167218311418, atol = 1e-2, rtol = 1e-1)
    end
end
